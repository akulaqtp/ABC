...
public class Test_MySource_Workflow_CWFWorkflowForm_AlternateURL1 {
    
    @Test
    public void test_MySource_Workflow_CWFWorkflowForm_AlternateURL1()
	    throws Exception {
	int rowCount_TestData = 0,columnindex;	
	String FilePath = null,AppURL;
	String FileName = "MySource_Workflow_CWFWorkflowForm_AlternateURL1.xls";	
	...
	FilePath = "TestData//TopHitPages//Workflows//";
	FileInputStream TestInputDataStream = new FileInputStream(new File(
		System.getProperty("user.dir") + "//TestData//TopHitPages//Workflows//"
			+ FileName));
