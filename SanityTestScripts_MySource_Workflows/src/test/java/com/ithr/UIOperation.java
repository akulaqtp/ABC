...
public class UIOperation {
    ...
    String FilePath, NewHire_EmployeeFileName, NewHire_Employee_SheetName, NewHire_Default_FileName,
	    NewHire_Default_SheetName, FilePathOutput, NewHire_UpdateDetails_FileName;
    String NewHire_QCData_FileName, NewHire_QCData_SheetName, NewHire_QCOffer_FileName, NewHire_QCOffer_SheetName,
	    Path;
    ...
    public void perform(Properties p, String operation, String objectName, String objectType, String value)
	    ...
	    InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, IOException, Exception {
	...
	// Login to the Application
	    ...
	    final String decryptedString = new String(cipher.doFinal(Base64.decodeBase64(MSJPassword)));
	...
	// clearing existing Value
	    ...
	    // Set text on control
	    driver.findElement(this.getObject(p, objectName, objectType)).sendKeys(textToBeSet);
	    Thread.sleep(3000);
	...
	// making email with first name
	    ...
	    // Set text on control
	    driver.findElement(this.getObject(p, objectName, objectType)).sendKeys(emailToBeSet);
	    Thread.sleep(3000);
	}
	...
	// click an element based on Index
	    ...
	    List<WebElement> stateList = driver.findElements(this.getObject(p, objectName, objectType));
	...
	// Select a Value from the State ListBox
	    ...
	    Thread.sleep(2000);
	    System.out.println("value" + value);
	    driver.findElement(By.xpath("html/body/div[7]/div/div[" + value + "]")).click();
	    System.out.println("value" + value);
	}
	// To Check an Object Existence
	if (operation.toUpperCase().equals("WAIT_FOR_EVENT_COMPLETE")) {
	    String successMsg = driver.findElement(this.getObject(p, objectName, objectType)).getText();
	...
	// To Set Text in the Text Box By clearing existing Value
	else if (operation.toUpperCase().equals("WAITFORPAGELOAD")) {
	    WebDriverWait wait1 = new WebDriverWait(driver, 200);
	    try {
		wait1.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(".//div[contains(text(),'" + value
			+ "')]")));
	    } catch (Exception e) {
	...
	// To Set the Date in the Text Box By clearing existing Value
	    ...
	    Date date = new Date();
	    String CurrentDate = dateFormat.format(date);
	    driver.findElement(this.getObject(p, objectName, objectType)).sendKeys(CurrentDate);
	    Thread.sleep(3000);
	}
	// To Set EMPLID in Bo-HRMS-Workforce-Employeement Screen
	else if (operation.toUpperCase().equals("SETEMPLID_EMPLOYEEMENT")) {
	    driver.findElement(this.getObject(p, objectName, objectType)).clear();
	    driver.findElement(this.getObject(p, objectName, objectType)).sendKeys(EmpID);
	    // Thread.sleep(100);
	}
	...
	// UnCheck the Checkbox if checked
	    ...
	    boolean isSelect = driver.findElement(this.getObject(p, objectName, objectType)).isSelected();
	    if (isSelect == true) {
		driver.findElement(this.getObject(p, objectName, objectType)).click();
	    }
	}
	...
	// To Click on a specific WebTable Row
		...
		String Cell_Value = driver.findElement(
			By.xpath(".//*[@id='gridview-1029']/table/tbody/tr[" + i + "]/td[3]/div")).getText();
		if (!Cell_Value.contains("Intern")) {
		    String WebTableCellValue = driver.findElement(
			    By.xpath(".//*[@id='gridview-1029']/table/tbody/tr[" + i + "]/td[1]/div")).getText();
	...
	// ->Process2 Search (Search the Candidate based on the Candidate Name)
	    ...
	    builder2.moveToElement(
		    driver.findElement(By.xpath("html/body/div[5]/div[5]/div/div[2]/div/div[2]/div/div/div[3]/div")))
		    .perform();
	    Thread.sleep(2000);
	    // Clicking on Name Filter
	    driver.findElement(By.xpath("html/body/div[5]/div[5]/div/div[2]/div/div[2]/div/div/div[3]/div/div"))
		    .click();
	    Thread.sleep(1000);
	    Actions builder = new Actions(driver);
	    System.out.println("In side the New Hire Process2");
	    // Highlighting Filters
	    builder.moveToElement(driver.findElement(By.xpath("html/body/div[11]/div/div[2]/div[2]/div[4]/a/span")))
		    .perform();
	    // builder.moveToElement(driver.findElement(By.xpath(".//*[@id='menucheckitem-1077-textEl']"))).perform();
	    Thread.sleep(1000);
	    // Clearing the text in text fields
	    driver.findElement(By.xpath("html/body/div[13]/div/div[2]/div/table/tbody/tr/td[2]/input")).clear();
	    System.out.println("value : " + value);
	    driver.findElement(By.xpath("html/body/div[13]/div/div[2]/div/table/tbody/tr/td[2]/input")).sendKeys(value);
	}

	// To Select the Job code
	else if (operation.toUpperCase().equals("SELECT_JOBCODE")) {
	    driver.findElement(By.xpath(".//*[@id='jobCodeSearchCont']/a/img")).click();
	    // Thread.sleep(5000);
	...
	// Check If CheckBox is not Selected
	    ...
	    boolean isSelect1 = driver.findElement(By.xpath(".//*[@id='sameAddressId']")).isSelected();
	    if (isSelect1 == false) {
		driver.findElement(By.xpath(".//*[@id='sameAddressId']")).click();
	    }
	...
	// FileUpload
	    ...
	    driver.findElement(this.getObject(p, objectName, objectType)).sendKeys(Path);
	}
	...
	// To Get Text
	    ...
	    // Get text of an element
	    EmpID = driver.findElement(By.xpath(".//*[@id='empId-0-1']")).getText();
	...
	// To Handle Dialogs with JobCode Error Message Text
	    ...
	    System.out.println("Job code Input after selecting Offer Letter value as Initial");
	    System.out.println("Alert String " + AlertString);
	    if (AlertString.toLowerCase().contains("Offer Job Code is inactive".toLowerCase())) {
		alert.accept();
		// Thread.sleep(3000);
		System.out.println("Job code Input after selecting Offer Letter value as Initial");
		driver.findElement(By.xpath(".//*[@id='formWF:offerJobCodeId0']")).clear();
		driver.switchTo().alert().accept();
		driver.findElement(By.xpath(".//*[@id='formWF:offerJobCodeId0']")).sendKeys("8874");
		Thread.sleep(3000);
		driver.findElement(By.xpath(".//*[@id='formWF:offerJustificationId0']")).sendKeys("Other");
		driver.findElement(By.xpath(".//*[@id='formWF:offerJustificationId0']")).sendKeys("Other");
	...
	// Select an option In Combo box based on the option Name
	    ...
	    List<WebElement> options = driver.findElements(By.className("x-boundlist-item"));
	...
	// Select all strips and click on a specified text
	    ...
	    List<WebElement> options = driver.findElements(By.className("x-tab-strip-text"));
	    for (WebElement element : options) {
		if (element.getText().equalsIgnoreCase(value)) {
		    element.click();
		    break;
	...
	// To Focus an Object
	    ...
	    Actions builder = new Actions(driver);
	    builder.moveToElement(driver.findElement(this.getObject(p, objectName, objectType))).perform();
	}
	// To Validate the Expected & Actual values
	else if (operation.toUpperCase().equals("ASSERT")) {
	    // Get text of an element
	    strActualText = driver.findElement(this.getObject(p, objectName, objectType)).getText();
	    Assert.assertEquals(strActualText, value);
	    System.out.println("Assertion Passed :" + "Both Actual and Expected values are matching");
	}
	// Switch to a frame
